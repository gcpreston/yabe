...
if false do
  ...
  Repo.delete_all(Listings.Sale)
  {:ok, sale1} = Listings.create_sale(%{
    quantity: 1,
    item_id: item1.id,
    buyer_id: buyer1.id
  })
